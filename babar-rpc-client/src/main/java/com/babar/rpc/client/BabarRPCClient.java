...
@Component
public class BabarRPCClient {

	@Value("${babar.client.netty.thread.number}")
	private int babarClientNettyThreadNumber;

	@Autowired
	BabarRPCClientChannelPoolHandler babarClientChannelPoolHandler;

	@Autowired
	BabarServiceDiscovery babarServiceDiscovery;

	private ChannelPool pool;
	private static final Logger logger = LoggerFactory.getLogger(BabarRPCClient.class);
	...
	public void send(BabarRPCRequest req){
