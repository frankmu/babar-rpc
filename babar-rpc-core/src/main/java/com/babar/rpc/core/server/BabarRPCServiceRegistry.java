...
@Component
public class BabarRPCServiceRegistry {
	...
	public BabarRPCServiceRegistry(@Value("${zookeeper.host}")String zooKeeperHost, @Value("${zookeeper.timeout}")int zooKeeperTimeout){
		try {
